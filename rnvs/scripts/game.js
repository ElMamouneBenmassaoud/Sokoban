...
// rnvs : fin de partie détectée après avoir tenté de charger un niveau suivant, pas dès la fin du dernier niveau

// rnvs : variables globales pas documentées
let currentLevel = 0;
// rnvs : @ts-ignore : pas ok eslint
// @ts-ignore
        ...
        for (const symbol of line) {
            ...
            switch (symbol) {
                ...
                case "#":
                    ...
                    break;
                case "@":
                    // rnvs : plutôt classes box et target
...
function allOnTarget() {
    // rnvs : le test ci-dessous n'est pas logiquement correct : il faut vérifier que toutes les boîtes sont sur une cible, pas que toutes les cibles ont une boîte
